...
class App:
    ...
    def createPort(self, com):
        ...
        print(self.motor1)
        print("Axis:")
        print(self.motor.axis)
        print("Axis1:")
        print(self.motor1.axis)
        #print(bus.get_module())
        ...
        reply = self.motor.send(6, 11, self.motor.motor_id, 0)
        print(reply.value)
        print("Limit1:")
        #print(self.motor.axis.max_current)
        print(self.motor1.axis.max_current)
        reply1 = self.motor1.send(6, 6, self.motor1.motor_id, 0)
        print(reply1.value)
        #rep = self.motor1.send(15, 5, self.motor1.motor_id, 0)
        #print(self.motor1.axis.left_limit_status)
        #def send( self, cmd, type, motorbank, value ):
        for i in range(0, 10):
            try:
                #print(self.motor1.send(6, 11, self.motor1.motor_id, 0))
                #print(self.motor.axis.left_limit_status)
                #print(self.motor1.axis.max_current)
                print(i)
                #print("gio")
                rep = self.motor1.send(15, i, self.motor1.motor_id, 0)
                print(rep.value)
                #print("reply 1")
                #reply1 = self.motor1.send(15, i, self.motor1.motor_id, 0)
                #print(reply1.value)
            except:
                print("------------")
    ...
    def readGIO(self):
        if self.stop == 1:
            try:
                ...
                #rep1 = self.motor.send(15, 5, self.motor.motor_id, 0)
                #rep2 = self.motor.send(15, 0, self.motor.motor_id, 0)
                print("value")
                if rep.value == 1:
                    print(rep.value)
                else:
