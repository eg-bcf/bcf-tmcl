...
class App:
    def __init__(self, master):
        ...
        self.communication_options.grid(row=0, column=0, padx=20, pady=20)

        self.com_label = Tkinter.Label(self.communication_options, text="Com Port")
        self.com_label.grid(row=0, column=0, padx=20, pady=20)

        self.com_port = Tkinter.StringVar()
        self.com_port.set("COM18")
        self.com_entry = Tkinter.Entry(self.communication_options, textvariable=self.com_port)
        self.com_entry.grid(row=1, column=0, padx=20, pady=20)
        ...
        self.movement_options.grid(row=0, column=1, padx=20, pady=20)

        self.rotate_left_label = Tkinter.Label(self.movement_options, text="Rotate Left Velocity")
        self.rotate_left_label.grid(row=0, column=0, padx=20, pady=20)
        ...
        self.rotate_right_label.grid(row=0, column=1, padx=20, pady=20)
        ...
        self.rotate_absolute_label.grid(row=0, column=2, padx=20, pady=20)
        ...
        self.rotate_relative_label.grid(row=0, column=3, padx=20, pady=20)
